...
import { ArrowRight, Clock, Calendar, LinkIcon, } from "lucide-react";
  ...
  return (
    <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            return (
              <Card key={index}>
                <CardHeader>
                  <feature.icon className="w-12 h-12 text-blue-500 mb-12 mx-auto" />
      ...
      <div className="mb-24">
        ...
        <h2 className="text-3xl font-bold text-center mb-12 text-blue-600">What Our User Say!</h2>
        ...
        <div className="grid gride-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"> 
          {howItWorks.map((step, index) => (
            <div className="text-center" key={index}>
              <div className="bg-blue-100 rounded-full w-16 flex items-center justify-center mx-auto mb-4">
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">Join thousands of professionals who trust Scheduler for efficient time management.</p>
        <Link href="/dashboard">
